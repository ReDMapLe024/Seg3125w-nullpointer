...
public class AlgebraQuizActivity extends Activity implements View.OnClickListener {
    ...
    public void calcResult (View view) {
        ...
        if (ans1 == null || ans2 == null || ans3 == null) { // All answers are empty.
            ...
            if (userData.getBoolean("online", false)) {
                ...
                int currentQuiz = userData.getInt("MathQuiz1", 0);
                ...
                if (points > 1) {
                    ...
                    ed.putInt("MathQuiz1", currentQuiz + points);
